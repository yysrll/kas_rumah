...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResourceState<T>);
}
...
/// @nodoc
class $ResourceStateCopyWith<T,$Res>  {
$ResourceStateCopyWith(ResourceState<T> _, $Res Function(ResourceState<T>) __);
}


/// Adds pattern-matching-related methods to [ResourceState].
extension ResourceStatePatterns<T> on ResourceState<T> {
...
class _Initial<T> implements ResourceState<T> {
  const _Initial();
...
class _Loading<T> implements ResourceState<T> {
  const _Loading();
...
@override
String toString() {
  return 'ResourceState<$T>.loading()';
}
...
class _Success<T> implements ResourceState<T> {
...
@override
String toString() {
  return 'ResourceState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ResourceStateCopyWith<T, $Res> {
...
class _Error<T> implements ResourceState<T> {
...
@override
String toString() {
  return 'ResourceState<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $ResourceStateCopyWith<T, $Res> {
